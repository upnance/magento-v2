    ...
    function (Component, upnanceRedirect) {
        ...
        return Component.extend({
            ...
            getPaymentLogo: function () {
                return window.checkoutConfig.payment.upnance_googlepay.paymentLogo;
            },
            getDescription: function () {
                return window.checkoutConfig.payment.upnance_googlepay.description;
            }
        });
    }
);
