    ...
    function (Component, upnanceRedirect) {
        ...
        return Component.extend({
            ...
            getPaymentLogo: function () {
                return window.checkoutConfig.payment.upnance_gateway.paymentLogo;
            },
            getDescription: function () {
                return window.checkoutConfig.payment.upnance_gateway.description;
            }
        });
    }
);