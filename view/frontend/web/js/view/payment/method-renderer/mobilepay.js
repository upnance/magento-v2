    ...
    function (Component, upnanceRedirect) {
        ...
        return Component.extend({
            ...
            getPaymentLogo: function () {
                return window.checkoutConfig.payment.upnance_mobilepay.paymentLogo;
            },
            getDescription: function () {
                return window.checkoutConfig.payment.upnance_mobilepay.description;
            }
        });
    }
);