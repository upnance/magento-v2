    ...
    function (Component, upnanceRedirect) {
        ...
        return Component.extend({
            ...
            getPaymentLogo: function () {
                return window.checkoutConfig.payment.upnance_applepay.paymentLogo;
            },
            getDescription: function () {
                return window.checkoutConfig.payment.upnance_applepay.description;
            }
        });
    }
);